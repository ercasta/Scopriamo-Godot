...
const SLASH = preload("Slash.tscn")
...
func vai_a_destra():
	...
	$Animazioni.set_flip_h(false) # true o false dipende dal lato verso cui è rivolto il personaggio.
	# Fine
...
func _on_Colpito_timeout():
	#collidi di nuovo con gli alieni (layer 3, bit 2)
